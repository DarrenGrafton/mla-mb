  ...
  return (
    <Layout pageTitle="Privacy Policy">
      ...
      <div>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to My Rep MB.
            </p>
          </li>
          ...
          <li>
            <p>Country refers to: Manitoba, Canada</p>
          </li>
          ...
          <li>
            <p>
              Website refers to My Rep MB, accessible from
              https://www.myrepmb.ca{" "}
            </p>
          </li>
        ...
        <p>By email: myrepmb@gmail.com</p>
      </div>
    </Layout>
  )
}
